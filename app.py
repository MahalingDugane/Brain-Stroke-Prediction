...
if os.environ.get("VERCEL"):
    ...
    database_path = os.path.join(app.instance_path, "mydb.db")
...
def predict():
    ...
    if request.method == 'POST':
        ...
        try:
            ...
            marriage_status = int(
                request.form.get('Marriage_Status')
            )
            ...
            bmi = float(
                request.form.get('intellectual_disability')
            )
